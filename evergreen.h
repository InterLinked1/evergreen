...
#define MIN_COLS_FOR_EXPANDED_LIST_INFO_WIDE 107
#define LIST_PANE_WIDTH (COLS >= MIN_COLS_FOR_EXPANDED_LIST_INFO_WIDE ? 36 : COLS >= MIN_COLS_FOR_EXPANDED_LIST_INFO ? 26 : 16)
...
#define IMAP_MAILBOX_NONEXISTENT IMAP_MAILBOX_NOSELECT
